...
**قابل توجه ایرانیان خارج از کشور که مایل به کمک به جریان اینترنت آزاد داخل ایران هستند**
اگر به اینترنت آزاد و بدون محدودیت دسترسی دارید، می‌توانید با چند دقیقه زمان، به کاربران داخل ایران کمک کنید.
با نصب اپلیکیشن 
**Orbot**
 و فعال کردن حالت 
**Kindness Mode (حالت مهربانی)**
، گوشی شما به‌عنوان یک میزبان برای پل‌های 
**Snowflake**
 در شبکه 
**Tor**
 عمل می‌کند. این کار به کاربران داخل ایران کمک می‌کند سانسور را دور بزنند و به اینترنت آزاد متصل شوند.
**🛠 آموزش فعال‌سازی:**
اپلیکیشن 
**Orbot**
 را نصب کنید (نسخه رسمی از سایت:
***🔗***
 
[https://orbot.app/en/](https://orbot.app/en/)
)
وارد برنامه شوید و به بخش 
**Orbot Settings**
 بروید.
گزینه 
**Kindness Mode**
...
**Connect**
 کنید تا فعال شود.
با فعال بودن این گزینه، اینترنت شما به‌صورت داوطلبانه و امن، بخشی از ترافیک کاربران سانسورشده را از طریق پل‌های Snowflake عبور می‌دهد.
***⚠️***
 نکات مهم:
حجم مصرفی معمولاً کم و کنترل‌شده است.
هر زمان بخواهید می‌توانید آن را غیرفعال کنید.
