...
***💻***
 لینک ساب سرور های اختصاصی کانال برای Hiddify و تمامی کلاینت های دیگر در تمام سیستم عامل ها  متصل در شرایط اینترنت ملی  https://raw.githubusercontent.com/peweza/PUBLICSUB/refs/heads/main/PewezaVPNPubSUB با کلیک روی لینک بالا کپی میشه و طبق آموزش تصویری در…

---

### 🕒 2026-02-16 08:33:07 UTC
***💻***
...
### 🕒 2026-02-16 08:29:17 UTC
***💻***
 
**قطع کامل اینترنت یک برنامه در ویندوز (بدون نصب هیچ نرم‌افزار اضافی!)**
● بعضی برنامه‌ها حتی وقتی بازشون نمیکنی ، توی پس‌زمینه به اینترنت وصل میشن؛ برای آپدیت، سینک شدن یا حتی ارسال داده ؛ حالا چطور میتونم دسترسی اینا به اینترنت رو قطع کنم؟
***1️⃣***
 روی آیکون برنامه راست‌کلیک کن و Open file location رو بزن ، بعد مسیر فایل .exe رو کپی کن.
***2️⃣***
 کلیدهای Win + R رو بزن و عبارت زیر رو بنویس و اینتر بزن :
wf.msc
***3⃣***
 از ستون چپ برو روی Inbound Rules و بعدش New Rule رو بزن و Program رو انتخاب کن.
***4⃣***
 حالا اون مسیر فایل exe رو که کپی‌کردی Paste کن.
***5⃣***
